...
class Trainers(models.Model):
    ...
    user = models.ForeignKey('users.CustomUser', on_delete=models.CASCADE, null=False, blank=False, related_name='trainers_user')
...
class Institutes(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey('users.CustomUser', on_delete=models.CASCADE, null=True, blank=True, related_name='institutes_user')
...
class CourseSkills(models.Model):
    ...
    skill = models.ForeignKey('taxonomy.Skills', on_delete=models.CASCADE, null=True, blank=True, related_name='course_skills_skill')
...
class QuizAttempts(models.Model):
    ...
    job_seeker = models.ForeignKey('candidates.JobSeekers', on_delete=models.CASCADE, null=True, blank=True, related_name='quiz_attempts_job_seeker')
...
class AssignmentSubmissions(models.Model):
    ...
    job_seeker = models.ForeignKey('candidates.JobSeekers', on_delete=models.CASCADE, null=True, blank=True, related_name='assignment_submissions_job_seeker')
...
class CourseQuestions(models.Model):
    ...
    job_seeker = models.ForeignKey('candidates.JobSeekers', on_delete=models.CASCADE, null=True, blank=True, related_name='course_questions_job_seeker')
    question_text = models.TextField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class CourseAnswers(models.Model):
    ...
    responder_user = models.ForeignKey('users.CustomUser', on_delete=models.CASCADE, null=True, blank=True, related_name='course_answers_responder_user')
...
class Enrollments(models.Model):
    ...
    job_seeker = models.ForeignKey('candidates.JobSeekers', on_delete=models.CASCADE, null=True, blank=True, related_name='enrollments_job_seeker')
    payment = models.ForeignKey('commerce.Payments', on_delete=models.CASCADE, null=True, blank=True, related_name='enrollments_payment')
...
class Certificates(models.Model):
    ...
    job_seeker = models.ForeignKey('candidates.JobSeekers', on_delete=models.CASCADE, null=True, blank=True, related_name='certificates_job_seeker')
