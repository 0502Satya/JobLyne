    ...
    <div className="min-h-screen bg-bg text-text transition-colors flex flex-col font-sans">
      ...
      <header className="flex items-center justify-between border-b border-border bg-surface px-6 md:px-12 py-4 sticky top-0 z-50 transition-all">
        <div className="flex items-center gap-6">
          ...
          <span className="bg-emerald-500/10 text-emerald-500 text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full hidden md:inline-block">Corporate Workspace</span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="size-11 rounded-2xl bg-gradient-to-tr from-emerald-500 to-[#059669] text-white flex items-center justify-center font-black shadow-lg shadow-emerald-500/20">
              HQ
            </div>
            <button 
      ...
      <main className="p-6 md:p-12 max-w-7xl mx-auto w-full flex-1 space-y-6 box-sizing">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-black tracking-tight text-text">Corporate Communications</h1>
          <p className="text-muted text-sm font-semibold">Engage with applicants directly. Discuss skillsets, background details, and organize scheduling.</p>
        </div>
            ...
            <div className="flex-1 overflow-y-auto divide-y divide-border/40">
              {loadingThreads ? (
                ...
                <div className="h-full flex flex-col items-center justify-center p-6 text-center text-muted">
                  ...
                  <p className="text-xs text-muted/80 mt-1 max-w-[220px]">Open your sourcing candidate pool in the Dashboard and click "Chat" to engage.</p>
                </div>
              ) : (
          ...
          <div className={`flex-1 flex flex-col h-full bg-bg/20 transition-all duration-300 ${
            ...
            {activeThread ? (
              ...
              <div className="h-full flex flex-col items-center justify-center p-6 text-center text-muted">
                ...
                <h2 className="text-xl font-black text-text mb-1">Corporate Inbox</h2>
                <p className="text-sm font-semibold max-w-sm">Select an applicant discussion from the side panel to view messages or sync hiring status.</p>
              </div>
            )}
          </div>
